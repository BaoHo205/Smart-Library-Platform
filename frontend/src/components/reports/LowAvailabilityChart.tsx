      ...
      <CardContent className="p-0">
        <Tabs defaultValue="books" className="w-full px-6">
          ...
          <TabsContent value="books" className="mt-4">
            <div className="max-h-[520px] space-y-2 overflow-y-auto px-6 pb-6">
              {books.length === 0 ? (
          ...
          <TabsContent value="categories" className="mt-4">
            <div className="px-6 pb-6">
              <div className="space-y-4">
                ...
                {Object.entries(categorizedBooks).map(
                    ...
                    return (
                      <Dialog key={category}>
                        <DialogTrigger asChild>
                          <button
                            className="h-20 w-full cursor-pointer rounded-lg border border-gray-200 p-4 transition-all duration-200 hover:border-gray-300 hover:shadow-sm"
                            onClick={() => setSelectedCategory(category)}
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-3">
                                <div
                                  className={`rounded-full p-2 ${config.bgColor}`}
                                >
                                  <IconComponent
