      ...
      <CardContent>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              value={filters.interval.toString()}
          ...
          <div className="space-y-2">
            ...
            <Select
              value={filters.mostBorrowedLimit.toString()}
              onValueChange={handleMostBorrowedLimitChange}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select
              value={filters.topReadersLimit.toString()}
              onValueChange={handleTopReadersLimitChange}
            >
              <SelectTrigger>
                <SelectValue placeholder="Select limit" />
              </SelectTrigger>
