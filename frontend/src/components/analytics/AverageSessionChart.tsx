          ...
          <div className="flex h-[400px] items-center justify-center text-gray-500">
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-gray-400">
                Try adjusting the time range to see more data
              </p>
            </div>
          </div>
        </CardContent>
              ...
              content={
                <ChartTooltipContent
                  ...
                  formatter={(value, name, props) => (
                    <div className="flex flex-col gap-1 rounded-lg border border-gray-200 bg-white p-3 shadow-lg">
                      ...
                      <div className="text-xs text-gray-500">
                        {props.payload?.totalSessions} sessions •{' '}
                        {props.payload?.uniqueUsers} users
                      </div>
                    </div>
                  )}
                />
        ...
        <div className="flex gap-2 leading-none font-medium">
          {allZeroValues ? (
            ...
            <>
              ...
              <TrendingUp
                className={`h-4 w-4 ${isPositiveTrend ? 'text-green-600' : 'rotate-180 transform text-red-600'}`}
              />
            </>
          )}
        </div>
